package com.viet.data.security;
...
public class InternalAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if ("true".equals(internalAuth)) {
            ...
            log.debug("Internal authentication - User: {}, Roles: {}", userId, userRoles);

            // PARSE ACTUAL ROLES từ gateway
            List<SimpleGrantedAuthority> authorities = parseRoles(userRoles);

            // Tạo authentication với actual user info
            ...
            log.debug("No internal auth header found");
        }
